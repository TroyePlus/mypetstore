...
CREATE TABLE `log` (
  `logUserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `courier` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `locale` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`orderid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `product` VALUES ('K9-DL-01', 'DOGS', 'Dalmation', '<image src=\"../images/dog6.gif\">Great dog for a Fire Station');
